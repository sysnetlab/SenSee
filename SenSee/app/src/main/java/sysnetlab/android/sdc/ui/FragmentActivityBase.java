...
public abstract class FragmentActivityBase extends ActionBarActivity {
    ...
    private void showAboutDialog() {
        ...
        // String textAuthors =
        // getResources().getString(R.string.text_about_authors);
        // String textVersion =
        // getResources().getString(R.string.text_about_version);
        ...
        try {
            ...
            Log.d("about", "Failure when trying to get the app version: " + e.getMessage());
