...
public class SensorPropertyListAdapter extends ArrayAdapter<SensorProperty> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            viewHolder.textViewPropertyName = (TextView) view
                    .findViewById(R.id.textview_sensor_property_name);
            viewHolder.textViewPropertyValue = (TextView) view
                    .findViewById(R.id.textview_sensor_property_value);
