...
public class ExperimentTests extends AndroidTestCase {
    ...
    public void testDefaultConstructor() {
        assertNotSame("The name was not set by the default constructor", null,
                mExperiment.getName());
        assertNotSame("The date was not set by the default constructor", null,
                mExperiment.getDateTimeCreatedAsString());
        assertNotSame("The device info was not set by the default constructor", null,
                mExperiment.getDeviceInformation());

        assertNotSame("The name was set empty by the default constructor", "",
                mExperiment.getName());
        assertNotSame("The date was set empty by the default constructor", "",
                mExperiment.getDateTimeCreatedAsString());
        assertNotSame("The device info was set empty by the default constructor", "",
                mExperiment.getDeviceInformation());
    ...
    public void testClone() {
        ...
        assertEquals("Failed to clone the Experiment tags List", mExperiment.getTags(),
                cloneExperiment.getTags());
        assertEquals("Failed to clone the Experiment notes List", mExperiment.getNotes(),
                cloneExperiment.getNotes());
        assertEquals("Failed to clone the Experiment name", mExperiment.getName(),
                cloneExperiment.getName());
        assertEquals("Failed to clone the Experiment name", mExperiment.getDeviceInformation(),
                cloneExperiment.getDeviceInformation());
    }
